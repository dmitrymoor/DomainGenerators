 ...
 * @author Dmitry Moor
 */
public class DomainGeneratorSpatialUncertain extends DomainGeneratorSpatial
{
	
	private static final Logger _logger = LogManager.getLogger(DomainGeneratorSpatialUncertain.class);
	 ...
	 */
	public DomainGeneratorSpatialUncertain(int numberOfGoods) throws SpacialDomainGenerationException 
	{
		super(numberOfGoods);
